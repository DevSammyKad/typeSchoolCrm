  ...
  return (
    <>
      ...
      >
        ...
        <div className="bg-gradient-to-tb row-start-1 row-end-4 animate-pulse rounded-2xl border border-zinc-200 ">
          <div className="relative flex h-full w-full items-center justify-center rounded-2xl border bg-background px-40 pb-40 pt-8 md:pb-60 md:shadow-xl">
        ...
        <div className="row-start-3 row-end-4 rounded-2xl border border-zinc-200 ">
          {/* <BentoGridAnimatedBeam /> */}
        </div>
      </div>
    </>
